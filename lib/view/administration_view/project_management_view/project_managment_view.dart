...
//    final projectVM = ref.watch(projectVMProvider);
//     final projects = projectVM.projects;
//     final isLoading = projectVM.isLoading;
//     final isInitialized = projectVM.isInit;
//   { Stack(
//         children: [
//           SizedBox(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (isLoading)
                    const WaitingMessageWidget('Lade Projektdaten')
                  else if (!isInitialized || projects.isEmpty)
                    const Center(child: Text('Bitte Daten eingeben'))
                  else
                    SizedBox(
                      height: 11 * 60,
                      child: Scrollbar(
